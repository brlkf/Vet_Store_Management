...
import static model.appointments_.Date;
...
public class CancelApp extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (appointment != null) {
                // Set the current timestamp as the deletedAt value
                appointment.setDeletedAt(new Timestamp(new Date().getTime()));
                appointmentsFacade.edit(appointment); // Update the appointment record
            }
            // Redirect to the page that shows appointments, assuming "appointments.jsp" here
